...
function buildMetadata(sample) {
  d3.json("samples.json").then((data) => {
    ...
    PANEL.html("");
    PANEL.append("h6").html("<b>ID: </b>" + result.id);
    PANEL.append("h6").html("<b>Location:</b> " + result.location);
    PANEL.append("h6").html("<b>Ethnicity:</b> " + result.ethnicity);
    PANEL.append("h6").html("<b>Gender: </b>" + result.gender);
    PANEL.append("h6").html("<b>Age: </b>" + result.age);
    PANEL.append("h6").html("<b>Belly Button Type: </b>" + result.bbtype);
    PANEL.append("h6").html("<b>Wash Frequency: </b>" + result.wfreq);
